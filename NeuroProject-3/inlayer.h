...
public:
    NArray< NType (*)(const NType&, const NType&) > activNeurons; //Функции активации для нейронов
    NArray< NType (*)(const NType&, const NType&, const NType&) > derivNeurons; //Производные функций активации для нейронов
    NType (*activation)(const NType&, const NType&); //Функция активации нейрона
    NType (*derivative)(const NType&, const NType&, const NType&); //Производная функции активации
